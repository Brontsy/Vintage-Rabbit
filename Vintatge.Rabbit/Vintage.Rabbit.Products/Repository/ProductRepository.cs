    ...
    internal class ProductRepository : IProductRepository, IMessageHandler<SaveProductMessage>
    {
        ...
        private IList<BuyProduct> GetProducts()
        {
            return new List<BuyProduct>()
            {
                ...
                new BuyProduct() { Id = 2423424, Title = "Tiger Woodland Mask", Cost = 9.95M, Description = "", Categories = new List<Category>() { new Category() { Id = 1, Name = "party-supplies" } }, Images = new List<ProductImage>() { new ProductImage() { Url = "/content/images/products/pm12361_tiger-woodland-mask-3.jpg" }}},
